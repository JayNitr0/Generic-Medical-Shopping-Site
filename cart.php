...
if (isset($_POST['product_id'], $_POST['quantity']) && is_numeric($_POST['product_id']) && is_numeric($_POST['quantity'])) {
    ...
    header('location: cart_index.php?page=cart');
    exit;
}
...
if (isset($_POST['placeorder']) && isset($_SESSION['cart']) && !empty($_SESSION['cart'])) {
    header('Location: cart_index.php?page=placeorder');
    exit;
}
...
<div class="cart content-wrapper">
    <h1>Shopping Cart</h1>
    <form action="cart_index.php?page=cart" method="post">
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="cart_index.php?page=product&id=<?=$product['product_id']?>"><?=$product['name']?></a>
                        <br>
                        <a href="cart_index.php?page=cart&remove=<?=$product['product_id']?>" class="remove">Remove</a>
                    </td>
