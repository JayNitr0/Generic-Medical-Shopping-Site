...
<body>
    ...
    <div id="addproducttext">
        <form action="addproduct_verification.php" method="post">
			...
			<label style=" padding:5px" id="Quantity">Description: </label><input type="text" id="Description" name="Description" /><br/>
            <label style=" padding:5px" id="Quantity">Quantity: </label><input type="number" id="Quantity" name="Quantity" /><br/>
